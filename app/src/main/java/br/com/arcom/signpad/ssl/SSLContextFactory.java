package br.com.arcom.signpad.ssl;
...
public class SSLContextFactory {
    ...
    private static br.com.arcom.signpad.ssl.SSLContextFactory theInstance = null;

    private SSLContextFactory() {
    }

    public static br.com.arcom.signpad.ssl.SSLContextFactory getInstance() {
        if(theInstance == null) {
            theInstance = new br.com.arcom.signpad.ssl.SSLContextFactory();
        }
        return theInstance;
    }
    ...
    public SSLContext makeContext(File clientCertFile, String clientCertPassword, String caCertString) throws Exception {
        ...
        TrustManager[] trustManagers = {new br.com.arcom.signpad.ssl.CustomTrustManager(trustStore)};
     ...
     * @return
     * @throws Exception
     * <p><b>Autoria: </b>Luiz Fernando - 25/09/2018</p>
     */
