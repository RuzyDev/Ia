...
const val INFO_SignPad = """    Este é um aplicativo de gerenciamento de suas viagens pela Arcom, ele não apenas registra sua chegada e partida de um destino, como também ajuda a calcular a distância percorrida entre os destinos e o custo total gasto com gasolina.
